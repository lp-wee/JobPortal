          ...
          {contacts.length === 0 ? (
            <Card className="flex-1">
              <CardContent className="py-12 flex flex-col items-center justify-center h-full text-center">
                ...
                <p className="text-xs text-muted-foreground mt-1">Работодатели могут написать вам через ваш профиль</p>
              </CardContent>
            </Card>
          ) : (
            contacts.map(contact => (
              ...
              >
                <CardContent className="p-3 flex items-center gap-3">
                  <div className="w-10 h-10 rounded-lg bg-blue-100 text-blue-700 font-black flex items-center justify-center text-sm flex-shrink-0">
          ...
          {!selectedContact ? (
            <Card className="flex-1">
              <CardContent className="h-full flex flex-col items-center justify-center text-center">
                ...
                <p className="text-muted-foreground font-medium">Выберите диалог слева</p>
              </CardContent>
            </Card>
          ) : (
            <Card className="flex-1 flex flex-col overflow-hidden">
              <div className="p-4 border-b flex items-center gap-3">
                ...
                <div>
                  ...
                  <p className="text-xs text-muted-foreground">{selectedContact.partner_role === 'employer' ? 'Работодатель' : 'Соискатель'}</p>
                </div>
              </div>
